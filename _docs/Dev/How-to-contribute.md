...
<!-- IMAGE_SUGGESTION: Hero banner or overview illustration showing the five contribution pathways (code, translations, docs, blog, UI/UX) as interconnected icons -->
...
👉 [Start contributing to code]({{ site.baseurl }}/Code-Contributions/)

## 🌍 Translations

Beaver is used worldwide, help us reach more people by translating the desktop app.  
You can start a brand-new translation or improve an existing one.

👉 [Help translate Beaver Notes]({{ site.baseurl }}/translate/)
...
👉 [Start contributing to the Docs]({{ site.baseurl }}/Contribute-to-docs/)
...
👉 [Start contributing to the Blog]({{ site.baseurl }}/Contribute-to-blog/)
