...
1. Locate the `_docs` directory. Inside, you'll find `Beaver Notes` containing `Dev` and `User` subfolders.
...
└── Beaver Notes
    ...
    │   ├── 2025-01-06-translate.md
    │   └── 2025-02-13-Code-Contributions.md
    └── User
        ├── 2024-06-17-Navigate-Interface.md
        ├── 2024-06-17-Markdown-Syntax.md
        └── 2025-01-19-Install.md
```
...
Once your Codespace is open, you’ll see an interface similar to the one shown below. In the sidebar, locate the `_docs` folder.

Here’s a graphical representation of the docs folder:
...
└── Beaver Notes
    ...
    └── User
        ...
        ├── 2024-06-17-Markdown-Syntax.md
        ├── 2024-06-17-Sync.md
        ├── 2024-06-17-Lock-Noted.md
        ├── 2024-06-17-Labels.md
        ├── 2024-06-17-Importing-Markdown.md
        ├── 2024-06-17-Mermaid-Block.md
        ├── 2025-01-19-Install.md
        └── 2025-02-03-Reset-Password.md
```
...
1. In the `_docs` folder, navigate to the appropriate subfolder:

   - **Beaver Notes > Dev**: For everything related to the project or desktop app development.
   - **Beaver Notes > User**: For everything related to the user experience of the desktop or mobile app.
   - **Beaver Notes (DEV) [mobile]**: For everything specific to mobile app development.
